...
export default function EditRestrictionV2Page() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <AppHeader
        breadcrumb={["Home", "Pricing & Strategy", "Restriction Guidelines V2", "Edit Rule"]}
      />

      <div className="flex flex-col flex-1 px-6 py-5 max-w-5xl">
        <div className="flex items-center gap-3 mb-6">
          <Link href="/restrictions-v2" className="flex items-center gap-1 text-[13px] hover:underline" style={{ color: "#006461" }}>
            <ChevronLeftIcon />
            Back
          </Link>
        ...
        <div className="flex items-center justify-end gap-3 mt-8 pt-5 border-t" style={{ borderColor: "#dde1e2" }}>
          <Link href="/restrictions-v2" className="px-5 h-9 flex items-center rounded border text-[13px] font-bold hover:bg-gray-50" style={{ borderColor: "#dde1e2", color: "#4f5b60" }}>
            Cancel
          </Link>
          <button
            disabled={!canSubmit}
