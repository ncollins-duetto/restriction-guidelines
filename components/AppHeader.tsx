...
function HelpIcon({ fill = "white" }: { fill?: string }) {
  return (
      ...
      >
        ...
        <div className="flex items-center gap-3 shrink-0">
          ...
          <button
            ...
            style={{ backgroundColor: helpActive ? "#C4FF45" : "transparent" }}
            title={helpActive ? "Hide coachmarks" : "Show coachmarks"}
          >
            <HelpIcon fill={helpActive ? colors.navBg : "white"} />
          </button>
